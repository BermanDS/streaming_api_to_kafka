...
class streamAPI:
    def __init__(self, 
        ...
        self.params_exec = params_execution if params_execution != {} else {'time_execution':30, 'data_amount':100}
        self.url = url
        self.method = 'GET'
            ...
            async for line in response.content:
                ...
                if line == '\n' or line == '\r' or line == '\r\n':
                    if lines[0] == ':ok\n':
                        ...
                        continue
                    if self.kind == 'wiki':
                        yield self.parse_wiki_approach_1(''.join(lines))
                    else:
                        None
                    lines = []
                else:
    ...
    def parse_wiki_approach_1(self, raw):
        """
        ...
        self.main_columns = ['title','timestamp','user','bot','parsedcomment']
